        ...
        <div className="flex flex-1 flex-col gap-4 p-4">
            <div className="mx-auto w-full space-y-4">
                <div className="flex items-center justify-between">
                    ...
                    <Link href="/admin/miscellaneous/license-states/form" className="bg-primary hover:bg-primary/90 text-primary-foreground px-4 py-2 rounded-md">
                            ...
                            {medicalLicenseStates.map((medicalLicenseState) => (
                                <TableRow key={medicalLicenseState._id}>
                                    ...
                                    <TableCell className="flex items-center justify-end gap-2 p-3">
                                        <Link href={`/admin/miscellaneous/license-states/form/${medicalLicenseState._id}`} className="flex justify-center items-center hover:text-primary">
